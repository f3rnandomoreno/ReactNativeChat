                    ...
                    <Card className="overflow-hidden bg-gradient-to-br from-blue-50 to-purple-50 border-0 shadow-lg">
                      <CardContent className="p-8 text-center space-y-6">
                        ...
                        <p className="text-gray-600 max-w-lg mx-auto text-base leading-relaxed">
                          Experimenta una forma de comunicación más natural y
                          sostenible. Sin bases de datos permanentes, reducimos
                          el consumo energético y las emisiones de CO2, mientras
                          mantenemos tus conversaciones privadas, más enfocadas
                          y comprensivas.
                        </p>
                      </CardContent>
                    </Card>
